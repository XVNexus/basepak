...
public class Test {
    public static void main(String[] args) {
        var types = Arrays.asList(Datatype.BOL, Datatype.I32, Datatype.I64, Datatype.F32, Datatype.F64,
                Datatype.CHR, Datatype.STR, Datatype.VEC, Datatype.MAP);
        for (var i = 0; i < types.size(); i++) {
            for (var j = 0; j < types.size(); j++) {
                var fromVal = Argument.def(types.get(i));
